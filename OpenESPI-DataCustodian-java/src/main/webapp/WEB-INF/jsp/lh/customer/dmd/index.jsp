			...
			<div class="container">
															...
															<div class="form-group">
																...
																<div class="input-group">
																	<div id="datetimepicker"
																		...
																		<input id="startTime" type="text" class=" datepicker form-control" placeholder="Select start date" contenteditable="false"></input>
															...
															<div class="form-group">
																...
																<div class="input-group">
																	<div id="datetimepicker2"
																		class="input-append date input-group">
																		<input id="endTime" type="text" class="datepicker form-control" placeholder="Select end date" contenteditable="false"></input>
																		<span class=" input-group-addon add-on"> <i
																			data-time-icon="icon-time"
																			data-date-icon="icon-calendar"><span
																				class="glyphicon glyphicon-calendar"></span></i>
																		...
																		<td>
																			<div class="btn-group">
																				...
																				<ul class="dropdown-menu" role="menu">
																					...
																					<li><a href="#" class="a-modal" data-toggle="modal"
																						data-target="#dateSelectionModal" data-usagepoint="${usagePoint.id}">Select
				...
				<script type="text/javascript">
					...
					var endDate = $('#datetimepicker2').datepicker({
					 ...
					 $('#datetimepicker').datepicker('update',new Date(usageMin*1000));
					 $('#datetimepicker2').datepicker('update',new Date(usageMax*1000));
