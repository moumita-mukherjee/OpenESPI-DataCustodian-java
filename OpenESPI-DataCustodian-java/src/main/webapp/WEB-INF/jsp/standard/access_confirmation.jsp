	...
	<div class="container">
		<div class="balance-section ">
			...
			<authz:authorize ifAllGranted="ROLE_USER">
				...
				<p>
					You hereby authorize <b>"<c:out value="${client.clientId}" />"
					</b> to access your Energy consumption data.
				</p>
						...
						<table class="table    table-striped table-hover">
							...
							<tbody>
								<c:forEach items="${scopes}" var="scope">
									...
									<tr>
										<td>${scope.key}</td>
										<td><input type="radio" name="${scope.key}" value="true"
											${approved}> Approve </input><input type="radio"
											name="${scope.key}" value="false" ${denied}> Deny</input></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
					</div>
					<label> <input name="authorize" value="Submit"
						type="submit" class="btn btn-primary"></label>
				</form>
			</authz:authorize>
