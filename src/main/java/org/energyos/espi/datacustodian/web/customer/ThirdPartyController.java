...
public class ThirdPartyController extends BaseController {
	...
	public String index(ModelMap model) {
		model.put("dcapplicationInformation", applicationInformationService.findById(1l));

		model.put("applicationInformationList", applicationInformationService.findAllThirdParties());
		return "/customer/thirdparties/index";
	}

	@RequestMapping(method = RequestMethod.POST)
	public String selectThirdParty(@RequestParam("Third_party") Long thirdPartyId,
		...
		ApplicationInformation dcapplicationInformation = applicationInformationService.findById(1l);
		...
		if (dcapplicationInformation.getDataCustodianId() != null) {
			return "redirect:" + thirdPartyURL + "?" + URLHelper.newScopeParams(applicationInformation.getScope())
					+ "&DataCustodianID=" + dcapplicationInformation.getDataCustodianId();
		}
		return "/customer/thirdparties/index";
	}
