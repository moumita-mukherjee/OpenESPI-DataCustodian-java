...
<security:authorize access="isAnonymous()">
                        <li class="active alt"><a id="login" class="my-london-hydro" href="<c:url value='/login'/>">Login_LHCustodian</a></li>
                    </security:authorize>
					</ul>
				</div>
			</div>
...
<nav class="ng-scope">
	<ul class="menu" >
		...
		<security:authorize access="isAuthenticated()">
		<li><a href="<c:url value='/custodian/retailcustomers'/>" class="ico5">Customer List</a></li>
		<li><a href="<c:url value='/custodian/upload'/>" class="ico5">Upload</a></li>
		<li><a href="<c:url value='/custodian/oauth/tokens'/>" class="ico5">OAuth Token Management</a></li>                 
                <li><a href="<c:url value='/espi/1_1/NotifyThirdParty'/>" class="ico5">Notify Third Party</a></li>  
