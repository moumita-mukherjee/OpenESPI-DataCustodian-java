...
<security:authorize access="isAnonymous()">
                        <li class="active alt"><a id="login" class="my-london-hydro" href="<c:url value='/login'/>">Login_LHCustomer</a></li>
                    </security:authorize>
					</ul>
				</div>
			</div>
...
<nav class="ng-scope">
	<ul class="menu" >
        <li><a id="profile" href="" class="ico5">Welcome: ${currentUser.firstName} ${currentUser.lastName}</a></li>
		<li><a href="<c:url value='/RetailCustomer/${currentCustomer.id}/home'/>" class="ico5">Home</a></li>
		<security:authorize access="isAuthenticated()">
