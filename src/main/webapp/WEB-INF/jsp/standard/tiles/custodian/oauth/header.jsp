...
<security:authorize access="isAnonymous()">
                        <li class="active alt"><a id="login" class="my-london-hydro" href="<c:url value='/login'/>">Login_Oauth</a></li>
                    </security:authorize>
					</ul>
				</div>
			</div>
...
<nav class="ng-scope">
	<ul class="menu">
		...
		<security:authorize access="isAuthenticated()">
		<li><a href="<c:url value='/custodian/oauth/tokens'/>" class="ico5">List Client OAuth Tokens</a></li>
                <li><a href="<c:url value='/custodian/oauth/tokens'/>" class="ico5">List User OAuth Tokens</a></li>  
                <li><a href="<c:url value='/custodian/oauth/tokens'/>" class="ico5">Delete User OAuth Token</a></li>  
                <li><a href="<c:url value='/custodian/oauth/tokens'/>" class="ico5">Delete All OAuth Tokens</a></li>   
