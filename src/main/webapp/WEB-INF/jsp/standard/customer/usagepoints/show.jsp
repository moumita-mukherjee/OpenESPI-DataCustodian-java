...
<a id = "downloadMyData" class="brand" href="<c:url value='/espi/1_1/resource/Batch/RetailCustomer/${currentCustomer.id}/UsagePoint/${displayBag["usagePointId"]}'/>">
...
<div class="container">
    <div class="row">
        <div class="span12">
            <h2>Usage Point: <c:out value="${displayBag['Description']}"/></h2>
            <p>Service Category: <c:out value="${displayBag['ServiceCategory']}"/></p>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <c:forEach var="meterReading" items="${displayBag['MeterReadings']}">
                    <tr>
                        <td>
                            <a href="<c:url value='${meterReading["Uri"]}' />">
                                <c:out value='${meterReading["Description"]}' />
                            </a>
                        </td>
                        <td><c:out value="${meterReading['ReadingType']}"/></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <c:forEach var="electricPowerUsageSummary" items="${displayBag['UsageSummmaryList']}">
                    <tr>
                        <td>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <c:forEach var="electricPowerQualitySummary" items="${displayBag['QualitySummaryList']}">
                    <tr>
                        <td>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        <td>
                            <c:out value="${displayBag['localTimeParameters'].tzOffset}"/>
                        </td>
                    </tr>
                </tbody>
            </table>
